...
export async function scanAllPairs(tf='5m', credentials={}, maxConcurrent=5) {
  ...
  // FIX BUG 3: threshold dinaikkan 62→70 — score 62 terlalu lemah (dominansi hanya 24%)
  // Score 70 = dominansi 40% — jauh lebih reliable untuk entry
  const best = ranked.find(r=>r.action!=='HOLD' && r.score>=70) || ranked[0] || null;
